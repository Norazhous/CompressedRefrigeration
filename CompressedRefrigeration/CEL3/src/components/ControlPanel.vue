		...
		<div class='container-fluid m-2 background-white border rounded'>
			...
			<div id="ControlPanel-buttons" class="row">
				...
				<div id="control-button-group" class="col-3 offset-2">
					...
					<div id="valve2-button-switch" class="form-check form-switch">
						<input id="valve2-button-input" class="form-check-input" type="checkbox" :checked="V2SwitchControllor"
							:disabled="V2SwitchDisabled" @click="valve2ColorChange()">
						<label id="valve2-button-label" class="form-check-label" :style="{ color: valve2Color }">V2 {{ V2state }}</label>
					</div>
					<div id="valve3-button-switch" class="form-check form-switch">
						<input id="valve3-button-input" class="form-check-input" type="checkbox" :checked="V3SwitchControllor"
							:disabled="V3SwitchDisabled" @click="valve3ColorChange()">
						<label id="valve3-button-label" class="form-check-label" :style="{ color: valve3Color }">V3 {{ V3state }}</label>
					</div>
					<div id="valve4-button-switch" class="form-check form-switch">
						<input id="valve4-button-input" class="form-check-input" type="checkbox" :checked="V4SwitchControllor"
							:disabled="V4SwitchDisabled" @click="valve4ColorChange()">
						<label id="valve4-button-label" class="form-check-label" :style="{ color: valve4Color }">V4 {{ V4state }}</label>
					</div>
				</div>
				...
				<div id="control-button-group" class="col-3">
					...
					<div id="valve7-button-switch" class="form-check form-switch">
						<input id="valve7-button-input" class="form-check-input" type="checkbox" :checked="V7SwitchControllor"
							:disabled="V7SwitchDisabled" @click="valve7ColorChange()">
						<label id="valve7-button-label" class="form-check-label" :style="{ color: valve7Color }"> V7 {{ V7state }}</label>
					</div>
