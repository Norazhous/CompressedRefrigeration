<template>
  ...
  <div id="videoElement1" v-if='getSessionExpired' class='row'>
    <div class='col-12'>
      <img id='session-end-image' src='https://app.practable.io/ed0/static/images/common/thank-you-screen.svg'
        alt='session ended'>
    </div>
  </div>
  <div v-else>
    <div class='row'>
      <div class='col-12'>
        ...
        <toolbar parentCanvasID="video-canvas1" parentComponentName="webcam" parentDivID='video-element'
          :showDownload='true' :showPopupHelp='false' :showOptions="false"></toolbar>
      </div>
