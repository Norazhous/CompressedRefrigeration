...
<div id="videoElement3" v-if='getSessionExpired' class='row'>
  <div class='col-12'>
...
<div v-else>
  <div class='row'>
      <div class='col-12'>
        ...
        <toolbar parentCanvasID="video-canvas3" parentComponentName="webcam" parentDivID='video-element' :showDownload='true' :showPopupHelp='false' :showOptions="false"></toolbar>
      </div>
...
export default {
  ...
  data(){
    ...
    watch:{
        url(){
            let canvas = document.getElementById("video-canvas3");
