...
<div v-else>
  <div class='row'>
      <div class='col-12'>
        ...
        <toolbar parentCanvasID="video-canvas1" parentComponentName="webcam" parentDivID='video-element' :showDownload='true' :showPopupHelp='false' :showOptions="false"></toolbar>
      </div>
